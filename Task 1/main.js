...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function applyVarintStyles(previewElement) {
    ...
    previews.forEach((preview, index) => {
        ...
        <div class="preview-img"><img src="${preview.img}" alt="img"/></div>
        ...
        applyVarintStyles(previewElement);
    });

    items.forEach((item, index) => {
        item.addEventListener("mouseenter", () => {
            isMouseOverItem = true;
            const newBg = `./asset/bg-${index + 1}.jpg`;
        ...
        const newActivePreview = document.querySelector(`.preview-${index + 1}`);
            ...
            applyVarintStyles(activePreview, true);
        }
        ...
        const activePreviewBg = activePreview.querySelector(".preview-img");
        gsap.to(activePreviewBg, {
        ...
        setTimeout(() => {
            if (!isMouseOverItem) {
                ...
                if (activePreview) {
                    ...
                    const defaultPreview = document.querySelector(".preview.degault");
